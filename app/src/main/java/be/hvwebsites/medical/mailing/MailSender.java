package be.hvwebsites.medical.mailing;
...
import be.hvwebsites.medical.mailing.provider.JSSEProvider;
import be.hvwebsites.medical.mailing.provider.MailProvider;
...
/*
                ...
                if(mail.getHtml() != null) {
                    ...
                    DataHandler handler = new DataHandler((DataSource) htmlDatasource);
