...
import be.hvwebsites.medical.adapters.MeasurementListAdapter;
import be.hvwebsites.medical.constants.GlobalConstant;
import be.hvwebsites.medical.entities.Belly;
import be.hvwebsites.medical.entities.BloodLower;
import be.hvwebsites.medical.entities.BloodUpper;
import be.hvwebsites.medical.entities.HeartBeat;
import be.hvwebsites.medical.entities.Measurement;
import be.hvwebsites.medical.helpers.BloodPressureM;
import be.hvwebsites.medical.helpers.MListLine;
